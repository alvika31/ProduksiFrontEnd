                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="<?= site_url('barangjadi') ?>">List Barang Jadi</a>
                        ...
                        <div class="collapse" id="alat" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="<?= site_url('barangjadi') ?>">List Alat</a>
                                <a class="nav-link" href="layout-sidenav-light.html">Tambah Alat</a>
                            </nav>
                        </div>
