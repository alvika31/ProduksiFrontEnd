<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Data Sudah Dikirim</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Data Sudah Dikirim</li>
            </ol>
            <?php echo $this->session->flashdata('hasil'); ?>
            <?php if (empty($barangjadi->data)) { ?>
                <div class="alert alert-danger" role="alert">
                    Data Dikirim Tidak Tersedia
                </div>
            <?php } else { ?>
                            ...
                            <div class="card shadow p-2 bg-body rounded">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-row bd-highlight mt-3">
                                        <a href="<?= site_url('Pengiriman/kirimbarang/' . $jadi->id) ?>" class="btn btn-primary">Lihat Detail</a>
                                    </div>
                                </div>
                            </div>
